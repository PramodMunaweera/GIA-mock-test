...
const LetterShape = ({ letter, rotation, flip, x, y }) => {
  const transform = `translate(${x}, ${y}) rotate(${rotation}, 20, 20) scale(${
    flip ? -1 : 1
  }, 1)`;
  return (
    <text
...
const getRandomQuestions = () => {
  ...
  Object.keys(TestCategories).forEach((category) => {
    ...
    selectedQuestions[TestCategories[category]] = [...categoryQuestions]
...
const App = () => {
  ...
  const getCategoryDescription = (category) => {
    const descriptions = {
      [TestCategories.REASONING]:
        "You will be given a statement describing a relationship. Then, you'll answer a question based on that statement.",
      [TestCategories.PERCEPTUAL_SPEED]:
        "Count the number of matching letter pairs.",
      [TestCategories.NUMBER_SPEED]:
        "Find the number that's furthest from the median value.",
      [TestCategories.WORD_MEANING]:
        "Find the word that doesn't belong with the others.",
      [TestCategories.SPATIAL_VISUALIZATION]:
        "Count how many pairs show the same shape.",
    };
                            ...
                            <div className="col-md-6">
                              ...
                              <div className="d-flex align-items-center mb-2">
                                <div className="me-4">
                                  ...
                                  <h3 className="mb-0">
                                    {Object.values(correctAnswers).reduce(
                                ...
                                <div>
                                  ...
                                  <h3 className="mb-0">
                                    {formatTime(
                                      Object.values(categoryTimes).reduce(
                                        (acc, time) => acc + time,
                                        0
                                      )
                                    )}
